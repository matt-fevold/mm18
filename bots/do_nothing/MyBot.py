...
# DO NOT CHANGE ABOVE ---------------------------
    ...
    me = game.get_self()
    # them = game.get_opponent()
    #
    # game.log(20*"-")
    # enhanced_logging(me)

    if game.turn_number > 300:
        game.log(f"{game.get_self().location}, {get_winning_stance(game.get_opponent().stance)}")
        game.submit_decision(game.get_self().location, get_winning_stance(game.get_opponent().stance))
